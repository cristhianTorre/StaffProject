...
export function getProyectos(direccion, servicio){
    let proyectos = [];
    let informacion = [];
    var leerStaffing = getStaffing();
...
function getEmpleados(proyecto){
    let empleados = [];
    const leerStaffing = getStaffing();
    for(const itemFila of leerStaffing){
...
function consultaInformacionProyecto(proyecto){
    let informacion = [];
    const leerProyectos = getProyecto();
